...
namespace Flow_CaseTracking.Controllers
{
    public class BoardsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Titulli,UserId,User")] Boards boards)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Titulli,UserId,User")] Boards boards)
        {
            if (id != boards.Id)
            {
                return NotFound();
